    ...
    <div className="max-w-4xl mx-auto p-6 bg-white border border-gray-200 shadow-sm rounded-xl my-8">
      ...
      <div className="mb-6 border-b border-gray-100 pb-4">
        <h1 className="text-2xl font-bold text-gray-800">
          {packageId
            ? "Modify Existing Tour Plan"
            : "Configure New Trekking Package"}
        </h1>
        <p className="text-sm text-gray-500">
          Step through the sequence tabs to manage details.
        </p>
      </div>
      ...
      <div className="min-h-95 bg-gray-50/50 rounded-xl p-6 border border-gray-100 mb-6">
        {/* STEP 1: BASIC INFO */}
        {currentStep === 0 && (
      ...
      <div className="flex justify-between items-center pt-4 border-t border-gray-100">
        <button
          type="button"
          className="px-4 py-2 border text-xs font-semibold rounded-lg bg-white text-gray-700 disabled:opacity-30"
          onClick={prev}
        ...
        <button
          type="button"
          className="px-4 py-2 bg-blue-600 text-white text-xs font-semibold rounded-lg disabled:opacity-30"
          onClick={next}
